...
const CessActivation = {
  ...
  initStep1a() {
    const panel = document.querySelector("[data-activation-substep='1a']");
  ...
  initStep1b() {
    const panel = document.querySelector("[data-activation-substep='1b']");
    const form = panel ? panel.querySelector("form") : null;
    if (!form) return;
    const alertBox = form.querySelector("[data-form-alert]");
    const submitBtn = form.querySelector("[data-submit]");
  ...
  revealEmailSubstep() {
    ...
    if (substep1a) substep1a.classList.add("hidden");
    if (substep1b) {
      substep1b.classList.remove("hidden");
      const emailInput = substep1b.querySelector("input[name='email']");
